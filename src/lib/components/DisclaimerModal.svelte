...
<Modal>
	<div
		class="flex w-full flex-col items-center gap-6 bg-gradient-to-b from-violet-500/40 via-violet-500/10 to-violet-500/0 px-5 pb-8 pt-9 text-center sm:px-6"
	>
		...
		<p class="text-sm text-gray-500">
			ИИ - это область активных исследований с известными проблемами, такими как создание предвзятых данных и дезинформация. Не используйте это приложение для принятия решений или советов, связанных с высокими ставками.
		</p>
