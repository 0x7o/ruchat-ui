...
<div class="flex w-full flex-col gap-5">
	...
	<div class="flex h-full flex-col gap-4 pt-4 max-sm:pt-0">
		...
		<label class="mt-6 flex items-center">
			...
			<div class="inline cursor-pointer select-none items-center gap-2 pl-2">
				Скрыть смайлики в списках чатов
			</div>
		</label>
		...
		<button
			...
			><CarbonTrashCan class="mr-2 inline text-sm text-red-500" />Удалить все чаты</button
		>
	</div>
		...
		<Modal on:close={() => (isConfirmingDeletion = false)}>
			...
			>
				...
				<p class="text-gray-800">
					Это действие удалит все ваши разговоры. Отменить его нельзя.
				</p>
				<button
					type="submit"
